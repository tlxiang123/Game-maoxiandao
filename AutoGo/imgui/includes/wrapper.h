...
extern void wrap_ImFont_CalcTextSizeAV(ImVec2 *pOut,ImFont* self,float size,float max_width,float wrap_width,const char* text_begin,const char** out_remaining);
extern const char* wrap_ImFont_CalcWordWrapPosition(ImFont* self,float size,const char* text,const int text_len,float wrap_width);
extern void wrap_ImFont_RenderTextV(ImFont* self,ImDrawList* draw_list,float size,const ImVec2 pos,ImU32 col,const ImVec4 clip_rect,const char* text_begin,float wrap_width,ImDrawTextFlags flags);
...
extern uintptr_t wrap_ImTextureData_GetPixels(ImTextureData* self);
extern uintptr_t wrap_ImTextureData_GetPixelsAt(ImTextureData* self,int x,int y);
...
extern uintptr_t wrap_igImMemdup(const uintptr_t src,size_t size);
extern void wrap_igImQsort(uintptr_t base,size_t count,size_t size_of_element,int(*compare_func)(void const*,void const*));
extern const char* wrap_igImTextCalcWordWrapNextLineStartV(const char* text,const int text_len,ImDrawTextFlags flags);
...
extern void wrap_ImDrawList_AddImage(ImDrawList* self,ImTextureRef tex_ref,const ImVec2 p_min,const ImVec2 p_max);
extern void wrap_ImDrawList_AddImageQuad(ImDrawList* self,ImTextureRef tex_ref,const ImVec2 p1,const ImVec2 p2,const ImVec2 p3,const ImVec2 p4);
extern void wrap_ImDrawList_AddImageRounded(ImDrawList* self,ImTextureRef tex_ref,const ImVec2 p_min,const ImVec2 p_max,const ImVec2 uv_min,const ImVec2 uv_max,ImU32 col,float rounding);
...
extern ImFontAtlasRectId wrap_ImFontAtlas_AddCustomRect(ImFontAtlas* self,int width,int height);
extern ImFont* wrap_ImFontAtlas_AddFontDefault(ImFontAtlas* self);
extern ImFont* wrap_ImFontAtlas_AddFontFromFileTTF(ImFontAtlas* self,const char* filename);
extern ImFont* wrap_ImFontAtlas_AddFontFromMemoryCompressedBase85TTF(ImFontAtlas* self,const char* compressed_font_data_base85);
extern ImFont* wrap_ImFontAtlas_AddFontFromMemoryCompressedTTF(ImFontAtlas* self,uintptr_t compressed_font_data,int compressed_font_data_size);
extern ImFont* wrap_ImFontAtlas_AddFontFromMemoryTTF(ImFontAtlas* self,uintptr_t font_data,int font_data_size);
...
extern ImFontBaked* wrap_ImFont_GetFontBaked(ImFont* self,float font_size);
...
extern void wrap_igDebugNodeTexture(ImTextureData* tex,int int_id);
...
extern ImFontAtlasRectId wrap_igImFontAtlasPackAddRect(ImFontAtlas* atlas,int w,int h);
extern void wrap_igImFontAtlasTextureGrow(ImFontAtlas* atlas);
extern const char* wrap_igImFontCalcWordWrapPositionEx(ImFont* font,float size,const char* text,const int text_len,float wrap_width);
extern ImGuiID wrap_igImHashData(uintptr_t data,size_t data_size);
extern ImGuiID wrap_igImHashStr(const char* data);
extern const char* wrap_igImTextCalcWordWrapNextLineStart(const char* text,const int text_len);
extern int wrap_igImTextStrFromUtf8(ImWchar* out_buf,int out_buf_size,const char* in_text,const char* in_text_end);
extern void wrap_igImage(ImTextureRef tex_ref,const ImVec2 image_size);
extern bool wrap_igImageButton(const char* str_id,ImTextureRef tex_ref,const ImVec2 image_size);
extern bool wrap_igImageButtonEx(ImGuiID id,ImTextureRef tex_ref,const ImVec2 image_size,const ImVec2 uv0,const ImVec2 uv1,const ImVec4 bg_col,const ImVec4 tint_col);
extern void wrap_igImageWithBg(ImTextureRef tex_ref,const ImVec2 image_size);
