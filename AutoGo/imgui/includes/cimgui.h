...
struct ImFontAtlas
{
    ...
    int TexMaxWidth;
    int TexMaxHeight;
    void* UserData;    ImTextureRef TexRef;    ImTextureData* TexData;
...
typedef ImU16 ImGuiTableDrawChannelIdx;extern ImGuiContext* GImGui;
typedef enum {
...
CIMGUI_API void igDrawRect(float x1,float y1,float x2,float y2,ImU32 color,float thickness);
